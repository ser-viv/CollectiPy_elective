...
class SpinMovementModel(MovementModel):
    ...
    def __init__(self, agent):
        ...
        self.spin_per_tick = self.spin_model_params.get("spin_per_tick", 50)
        ...
        self.num_spins_per_group = self.spin_model_params.get("num_spins_per_group", 6)
    ...
    def step(self, agent, tick: int, arena_shape, objects: dict, agents: dict) -> None:
        ...
        #self.spin_system.run_spins(steps=2)
...
register_movement_model("spin_model_B", lambda agent: SpinMovementModel(agent))
